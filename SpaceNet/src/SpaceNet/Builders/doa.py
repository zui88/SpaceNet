...
from SpaceNet.Utils.DeepAugmented.Networks.DeepClassic.finder import (
    build_network as build_finder,
)
from SpaceNet.Utils.DeepAugmented.Networks.DeepClassic.selector import (
    build_network as build_selector,
)
from SpaceNet.Utils.DeepAugmented.Networks.DeepClassic.surrogate import (
    build_network as build_surrogate,
)
from SpaceNet.Utils.DeepAugmented.Networks.DeepRoot.rcov import (
    build_network as build_rcov,
)
                    ...
                    (
                        {
                            ...
                            "n_samples": configs.base.signal.n_samples,
                        },
                        {
                            "scan_range": configs.base.scan_range,
                            "m_antennas": configs.base.array.antennas,
                            "d_sources": configs.base.d_sources,
                        },
                        {"m_antennas": configs.base.array.antennas},
                    ),
                )
