...
class ClassicDOA(Recipe):
    def __init__(
        ...
        self.register_node(
            "inv_spec", ComputePseudoInverseSpectrum(self.scan_range, self.steering)
        )
        ...
        self.connect_node("peak_finder", "peaks", "doa", "peaks")

        self.connect_node("doa", "doa", "output", "doa")
        self.connect_node("inv_spec", "SpectrumObj", "output", "SpectrumObj")
