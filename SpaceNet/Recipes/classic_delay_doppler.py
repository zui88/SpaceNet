...
class ClassicDelayDoppler(Recipe):
    ...
    def __init__(self,
        ...
        self.register_node("signal_sources", SignalSources(
            d_sources,
            False,
        ))
        self.register_node("noise_subspace", NoiseSubspace())
        self.register_node("inv_spec", DelaySpectrum(
            scan_range,
            signal_provider,
            observation_context,
        ))
        ...
        self.connect_node("inv_spec", "taus_grid",
                          "delay_doppler", "taus_grid")
        self.connect_node("inv_spec", "omegas_grid",
                          "delay_doppler", "omegas_grid")
        ...
        self.connect_node("delay_doppler", "taus",
                          "output", "tau_est")
        self.connect_node("delay_doppler", "omegas",
                          "output", "omega_est")
